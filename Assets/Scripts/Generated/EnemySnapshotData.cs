...
public struct EnemySnapshotData : ISnapshotData<EnemySnapshotData>
{
    public uint tick;
    ...
    public void PredictDelta(uint tick, ref EnemySnapshotData baseline1, ref EnemySnapshotData baseline2)
    {
    ...
    public void Serialize(int networkId, ref EnemySnapshotData baseline, ref DataStreamWriter writer, NetworkCompressionModel compressionModel)
    {
    ...
    public void Deserialize(uint tick, ref EnemySnapshotData baseline, ref DataStreamReader reader,
    ...
    public void Interpolate(ref EnemySnapshotData target, float factor)
    {
